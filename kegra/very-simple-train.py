...
gc1 = Dense(HIDDEN_DIM, activation='relu', bias=False)(MergeDot(X.shape[1])([feats_in, graph_in]))
gc2 = Dense(y.shape[1], activation='softmax', bias=False)(MergeDot(HIDDEN_DIM)([gc1, graph_in]))
...
_ = model.fit(
  {"feats_in" : X, "graph_in" : adj_norm}, y, 
...
print("\nFinal:")
res = model.evaluate({"feats_in" : X, "graph_in" : adj_norm}, y, verbose=False, batch_size=adj_norm.shape[0])
